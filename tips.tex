...
\end{verbatim}
  ...
  \item Loops:
    \begin{itemize}
      \item \texttt{break} exits the innermost loop only (\texttt{for} or \texttt{while}). If one wants to exit all of them, a flag (a \texttt{_Bool}/\texttt{bool}) should be used.
